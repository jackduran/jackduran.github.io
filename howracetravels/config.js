var config = {
    ...
    chapters: [
...

        {
            ...
            description: 'New York City has had a large Dominican community since as early as the 1960s. However, the community didn`t start to boom until the 1980s. Since then, New York City has been the home to the largest concentration of Dominicans outside of Dominican Republic, so much so that Washington Heights, the center of Dominican community in the U.S., has been dubbed “Little Santo Domingo.” In addition to Washington Heights, Dominican immigrants have settle in nearby Inwood, The Bronx, Harlem, Corona, Queens, as specific Brooklyn neighborhoods, such as Bushwick. Many Dominicans have also settled in nearby New Jersey. Within the United States, the Migration Policy Institute states, that 60% of all Dominican immigrants live in either New York or New Jersey. And, they make up nearly 10% of New York City’s population. Today, Dominican immigrants have become the fourth-largest Hispanic immigrant group in the U.S., and over the past decade has overtaken Puerto Ricans to become the largest Latino immigrant group in New York City. Dominicans have influenced New York City culture so much so that Dominican bodegas, for instance, have become a staple throughout the city.',
            location: {
...

        {
            ...
            title: '',
            image: '',
            description: 'Because of this, and the “racial fusion” of the Dominican population, Torres-Saillant argues, “one cannot easily speak of blacks versus whites or identify cases in which people align themselves politically along racial lines.” The “Black,” he says, as a differentiated segment of the society does not exist in the Dominican self-imagination, in their racial, or rather deracialized, imaginaries. But, in the U.S., Torres-Saillant, argues, “[C]ountless Dominicans, particularly dark-skinned ones, find themselves having to choose among options which their historical experience did not prepare them to recognize.” This causes, what I argue is, a racial affective disorientation in which Dominican immigrants’ conception of race is completely reconfigured by racial codes that transfigures them as “Black,” even when they might not identify as such. “Dominicans cannot help but realize that in the United States race matters tremendously, ours as well as that of others. In this country Dominicans join the cast of an inescapable social drama wherein whites set the normative standard and ‘black people are viewed as a ‘them,’’ to borrow the language of Cornel West,” Torres-Saillant says. “For despite their particular manner of racial self-representation, Dominicans come into a society that, in the words of Frank Bonilla, ‘knows only black and white.’” Navigating American society, and its starkly different racial codes, as a Dominican immigrant, is a complex journey, a migration of its own if you will, that can transform what it fundamentally means to be Dominican outside of the Dominican Republic, in America.',
            location: {
